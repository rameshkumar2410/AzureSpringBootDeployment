...
public class AzureBlobConfiguration extends AbstractAppender {
	...
	public static AzureBlobConfiguration createAppender(@PluginAttribute("name") String name,
		...
		//	String sas = getPropertyOrFail(SASURL);
			...
			try {
				return new AzureBlobConfiguration(name, filter, layout, true, Property.EMPTY_ARRAY, SASURL, prefix1,
						prefix2);
...
//			try {
//				return new AzureBlobConfiguration(name, filter, layout, true, Property.EMPTY_ARRAY, accountName,
//						accountKey, containerName, prefix1, prefix2);
