...
public class AzureBlobConfiguration extends AbstractAppender {
    ...
    protected AzureBlobConfiguration(
            String name,
            Filter filter,
     ...
     */
    @PluginFactory
    public static AzureBlobConfiguration createAppender(
        ...
        if (webapps) {
            ...
            try {
                return new AzureBlobConfiguration(name, filter, layout, true, Property.EMPTY_ARRAY, sas, prefix1, prefix2);
            ...
            try {
                return new AzureBlobConfiguration(name, filter, layout, true, Property.EMPTY_ARRAY, accountName, accountKey, containerName, prefix1, prefix2);
